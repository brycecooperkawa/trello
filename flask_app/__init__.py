...
def create_app(debug=False):
	...
	# Add an example board to the owner user
	query = "UPDATE users SET board_ids = %(board_ids)s WHERE email = %(email)s"
	parameters = {"board_ids": json.dumps([1]), "email": 'owner@email.com'}
